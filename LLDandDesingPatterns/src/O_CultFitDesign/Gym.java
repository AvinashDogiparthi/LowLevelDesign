...
public class Gym {
    ...
    public void initializeWorkout(){
        ...
        Slot slot1 = new Slot(1,2,50);
        Slot slot2 = new Slot(2,3,50);
        Slot slot3 = new Slot(3,4,50);
        ...
        Slot slot4 = new Slot(1,2,50);
        Slot slot5 = new Slot(2,3,50);
        Slot slot6 = new Slot(3,4,50);
    ...
    public int bookSlot(int startTime, int endTime, WorkOutType workOutType, User user){
        ...
        if(!workOut.availableSlotsList().isEmpty()){
            ...
            workOut.bookSlot(slot.getSlotId(),user);
    ...
    public void cancelBookedSlot(Slot slot, WorkOutType workOutType, User user){
        WorkOut workOut = this.typeWorkOutMap.get(workOutType);
        workOut.cancelBooking(slot.getSlotId(),user);
        System.out.println("GYM::cancelSlot - requested slot cancelled successfully");
    }
